...
assert abs(tdcisd.compute_ground_state_energy() - -2.887_594_831_090_936) < 1e-7
...
rho_qp = tdcisd.compute_one_body_density_matrix(tol=1e-6)
...
np.savetxt("tdcisd_helium_energies_real_0.1.dat", td_energies.real)
np.savetxt("tdcisd_helium_overlap_0.1.dat", td_overlap)
np.savetxt("tdcisd_helium_dipole_z_0.1.dat", dip_z)
